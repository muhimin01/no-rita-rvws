...
Updated for **Nuclear Option 0.32**
...
2. Place the `RITA_RU` folder from the mod in your BepInEx `plugins` folder.

#### Uninstallation
Delete the `RITA_RU` folder from your BepInEx `plugins` folder.
